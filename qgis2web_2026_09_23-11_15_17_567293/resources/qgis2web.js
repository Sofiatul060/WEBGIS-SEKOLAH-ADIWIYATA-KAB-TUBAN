...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [111.567220, -7.165039, 112.222464, -6.754171],
            units: 'degrees'
        })
    })
});
...
map.getView().fit([111.405611, -7.169134, 112.374810, -6.704276], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">SEKOLAH ADIWIYATA KABUPATEN TUBAN</h2>';
        return titleElement;
    })(),
